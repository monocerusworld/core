...
import '../../../../../contracts/TartzFactory.sol';
...
contract SetupTokens {
    ...
    constructor() public {
        ...
        // since this is what the tartz factory will do when you create the pool
...
contract TartzMinter {
    ...
    function setPool(TartzPool _pool) public {
        pool = _pool;
    }
