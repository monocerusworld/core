...
describe('TartzPool', () => {
  ...
  let pool0: MockTimeTartzPool
  let pool1: MockTimeTartzPool
  ...
  let swapTargetCallee: TestTartzCallee
  let swapTargetRouter: TestTartzRouter
