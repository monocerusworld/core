...
describe('TartzFactory', () => {
  ...
  const fixture = async () => {
    ...
    return (await factoryFactory.deploy()) as TartzFactory
  }
  ...
  before('load pool bytecode', async () => {
    poolBytecode = (await ethers.getContractFactory('TartzPool')).bytecode
  })
  ...
  async function createAndCheckPool(
    ...
    const poolContractFactory = await ethers.getContractFactory('TartzPool')
